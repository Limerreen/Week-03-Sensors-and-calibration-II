...
ตอบ เพราะไมโครคอนโทรลเลอร์ (ขา ADC) สามารถอ่านได้เฉพาะ แรงดันไฟฟ้า ไม่สามารถอ่านค่าความต้านทานของ LDR ได้โดยตรง ต้องใช้วงจร Voltage Divider แปลงการเปลี่ยนแปลงความต้านทานของ LDR ให้กลายเป็นแรงดันไฟฟ้าที่ ADC อ่านค่าได้
2. ทำไมต้องเก็บข้อมูลหลายจุดก่อนทำ Calibration?
ตอบ เพราะความสัมพันธ์ระหว่างค่าความต้านทานของ LDR กับความเข้มแสง (Lux) ไม่เป็นเส้นตรง แต่เป็นแบบ Exponential/Power Law การเก็บข้อมูลหลายๆ จุดครอบคลุมทุกย่านแสง จะช่วยให้สร้างกราฟ Trendline และหาสมการแปลงค่าได้ครอบคลุมและแม่นยำตลอดช่วงการใช้งาน มากกว่าการวัดแค่ 1–2 จุด
3. ถ้า Noise มากกว่าสัญญาณจริง จะเกิดอะไรขึ้น?
ตอบ ค่า ADC ที่อ่านได้จะแกว่งและผันผวน ทำให้เมื่อคำนวณผ่านสมการ Calibration ค่า Lux ที่ได้จะไม่อยู่กับที่และขาดความน่าเชื่อถือ ส่งผลให้ระบบนำค่าไปสั่งงานผิดพลาด เช่น ไฟกระพริบรัวๆ หรือตัดสินใจผิดพลาด
4. ทำไมการวางตำแหน่งเซนเซอร์จึงสำคัญต่อ Signal Integrity?
ตอบ เพราะตำแหน่งการวางเซนเซอร์มีผลโดยตรงต่อการรับแสงจริง ถ้าวางในมุมที่มีเงามือบัง แสงสะท้อนรบกวน หรือไกลจากแหล่งกำเนิดแสงเกินไป จะทำให้สัญญาณที่วัดได้ไม่สะท้อนค่าสภาพแวดล้อมจริง ส่งผลให้ข้อมูลเพี้ยนตั้งแต่ต้นทาง และทำ Calibration ไม่แม่นยำ
5. ถ้า ADC มี Resolution ต่ำ จะส่งผลอย่างไรต่อความแม่นยำ?
ตอบ ทำให้เกิด Quantization Error สูง เพราะช่วงการแบ่งระดับสัญญาณสั้นลง (เช่น 8-bit แบ่งได้ 256 ระดับ เทียบกับ 12-bit ที่แบ่งได้ 4,096 ระดับ) ผลคือเซนเซอร์จะไม่สามารถตรวจจับการเปลี่ยนแปลงของแสงเพียงเล็กน้อยได้ ค่า Lux ที่คำนวณได้จะกระโดดเป็นช่วงกว้างๆ ทำให้ความละเอียดและความแม่นยำในการวัดลดลง
...
| --- | -------------------------------------------------------------- | -------------------- | ------ |
| 1.1 | อธิบายหลักการทำงานของ LDR ได้ถูกต้อง                           |            3          |   พอเข้าใจเบื้องต้นว่าแสงเปลี่ยนทำให้ความต้านทานเปลี่ยน แต่ยังไม่แม่นเรื่องการคำนวณเชิงลึก     |
| 1.2 | อธิบายการทำงานภายใน LDR (โฟตอน → อิเล็กตรอน → conduction band) |         2             |   รู้ว่าเกี่ยวกับระดับพลังงานและแสงตกกระทบ แต่จำรายละเอียดทฤษฎีระดับอะตอม/สารกึ่งตัวนำไม่ได้     |
| 1.3 | เข้าใจว่าความสัมพันธ์ R vs Lux ไม่เป็นเส้นตรง                  |            3          |    เข้าใจจากการสังเกตค่าและกราฟว่ามันโค้ง แต่ยังไม่ชินกับการคิดเป็นสมการ Exponential    |
| 1.4 | เข้าใจเหตุผลที่ต้องใช้ Voltage Divider                         |         3             |  เพิ่งมาเข้าใจตอนต่อวงจรผิดแล้วค่าค้างว่าต้องแปลง R เป็น V เพื่อให้บอร์ดอ่านค่าได้      |

### **ส่วนที่ 10.2 — การต่อวงจรและอ่านค่า ADC (20 คะแนน)**

| ข้อ | รายการ                              | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ----------------------------------- | -------------------- | ------ |
| 2.1 | ต่อวงจร Voltage Divider ได้ถูกต้อง  |           2           |   ตอนแรกยังต่อผิดจุดทำให้อ่านค่าไม่ได้ ต้องได้รับการแนะนำชี้จุดย้ายสายถึงจะทำงานได้ถูกต้อง     |
| 2.2 | เลือกค่า R คงที่เหมาะสม (เช่น 10kΩ) |         3             |   ต่อตามที่ใบงานและวงจรกำหนดมาให้    |
| 2.3 | เขียนโปรแกรมอ่านค่า ADC ได้ถูกต้อง  |       3               |  ใช้โค้ดสำเร็จรูปตามใบงานมาปรับแก้ได้ แต่ยังเขียนโครงสร้างโค้ดเองทั้งหมดไม่ได้      |
| 2.4 | ใช้ ESP‑IDF ADC + Calibration ได้   |    2                  |  ติดปัญหา Environment และ Build error หลายจุด    |

### **ส่วนที่ 10.3 — การเก็บข้อมูลจริง (20 คะแนน)**

| ข้อ | รายการ                             | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------------------- | -------------------- | ------ |
| 3.1 | เก็บข้อมูล ADC อย่างน้อย 5–7 จุด   |       3               | พยายามทดลองเก็บข้อมูลตามสภาพแสงต่าง ๆ ได้ครบตามจำนวนจุด       |
| 3.2 | วัดค่า Lux จากมือถือได้ถูกต้อง     |       3               | ใช้งานแอปบนมือถืออ่านค่าเทียบได้ แต่ตำแหน่งเซนเซอร์อาจจะยังไม่ตรงเป๊ะ 100%       |
| 3.3 | จดข้อมูลเป็นตารางครบถ้วน           |       5               |  บันทึกค่าลงตารางได้ตามที่ทดลองจริง      |
| 3.4 | ควบคุมสภาพแสงให้คงที่ระหว่างการวัด |         4             |  ทำได้ระดับหนึ่ง มีค่าแกว่งบ้างตามการขยับมือและเงา      |
...
| ข้อ | รายการ                                        | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | --------------------------------------------- | -------------------- | ------ |
| 4.1 | สร้างกราฟ Scatter ADC vs Lux ได้              |         3             |   นำข้อมูลเข้าโปรแกรมและทำกราฟจุดกระจายได้ตามขั้นตอน     |
| 4.2 | เลือก Trendline เหมาะสม (Linear / Polynomial) |       2               |   อาศัยดูค่า R² จากโปรแกรมช่วยเลือก แต่ยังไม่ค่อยเข้าใจหลักการเลือกด้วยตัวเอง     |
| 4.3 | อ่านสมการจากกราฟได้ถูกต้อง                    |        3              |   ดึงค่าความชันและจุดตัดจากสมการบนกราฟมาใช้งานได้     |
| 4.4 | นำสมการไปใช้ในโค้ดได้                         |         2             |   ต้องระวังเรื่องชนิดข้อมูลและแปลงตัวแปรลงในภาษา C ยังทำได้ไม่คล่อง     |
| 4.5 | วิเคราะห์ว่า Linear หรือ Polynomial เหมาะกว่า |           2           |    วิเคราะห์ตามค่า R² ที่ได้จากโปรแกรมเป็นหลัก แต่ยังอธิบายเหตุผลเชิงทฤษฎีไม่ลึก    |
### **ส่วนที่ 10.5 — การทดสอบผลลัพธ์และวิเคราะห์ (15 คะแนน)**

| ข้อ | รายการ                                   | คะแนน<br>(0–5 คะแนน) | เหตุผล |
| --- | ---------------------------------------- | -------------------- | ------ |
| 5.1 | ทดสอบจุดแสงใหม่ที่ไม่ได้ใช้ตอนเก็บข้อมูล |            3          |  สุ่มลองทดสอบใหม่ได้ แต่ยังเก็บข้อมูลทดสอบได้ไม่หลากหลายจุด      |
| 5.2 | เปรียบเทียบ Lux มือถือ vs Lux จากโค้ด    |        3              | ดูผลลัพธ์ว่าตรงกันไหมได้ แต่ยังมีค่าความคลาดเคลื่อนค่อน  |
| 5.3 | วิเคราะห์ความคลาดเคลื่อนและสาเหตุได้     |         2             |   รู้ว่ามี Error จากการต่อวงจรและตำแหน่งการวาง แต่ยังวิเคราะห์ปัจจัยทางไฟฟ้าได้ไม่ครบ     |
.................................................................

###  **คะแนนรวมทั้งหมด:** ` 56 / 100`
...
1. จุดไหนในใบงานที่คิดว่ายากที่สุด? 
   ตอบ การแก้ปัญหาเรื่องโปรแกรม (Environment ของ ESP-IDF ใน VS Code) และการไล่เช็กตำแหน่งขาพินกับรอยต่อวงจรบน Breadboard ให้ถูกต้องเพราะตอนแรกอ่านค่าได้เป็น 0 ตลอด
    
2. ถ้าทำใบงานนี้อีกครั้ง จะปรับปรุงอะไร? 
   ตอบ จะตรวจเช็กตำแหน่งพินบนบอร์ดและจุดเชื่อมต่อสายบน Breadboard ให้แม่นยำตั้งแต่แรก และจะพยายามนิ่งมือให้มากกว่าเดิมตอนใช้แอปมือถือวัดแสงเพื่อไม่ให้ค่า Lux แกว่ง
3. ส่วนไหนที่คิดว่าตนเองเข้าใจดีมาก? 
   ตอบ เข้าใจขั้นตอนการเก็บข้อมูลจริง การอ่านค่า ADC เพื่อนำไปเทียบกับค่า Lux จากแอปพลิเคชัน และการนำข้อมูลไปสร้างตารางกับพล็อตกราฟ Scatter ใน Excel
